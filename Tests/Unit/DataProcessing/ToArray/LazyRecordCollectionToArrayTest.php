...
/**
 * Testcase for class "LazyRecordCollectionToArray".
 *
 * @author Netzbewegung
 */
class LazyRecordCollectionToArrayTest extends AbstractDataProcessorTestCase
{
    /**
    ...
    public function processWithEmptyDataArrayReturnsEmptyArray(): void
    {
        ...
        $instance = GeneralUtility::makeInstance(LazyRecordCollectionToArray::class);
    ...
    {
        $subject = [
            (object)['uid' => 1, 'title' => 'Record 1'],
            (object)['uid' => 2, 'title' => 'Record 2'],
        ];
        $configuration = [];
    ...
    {
        $subject = [
            (object)['uid' => 1, 'title' => 'Record 1', 'value' => 100],
            (object)['uid' => 2, 'title' => 'Record 2', 'value' => 200],
        ];
        $configuration = [];
    ...
    public function processWithArrayContainingObjectsWithMixedDataTypesReturnsArray(): void
    {
        $subject = [
            (object)['uid' => 1, 'title' => 'Record 1', 'value' => 100],
            (object)['uid' => 2, 'title' => 'Record 2', 'value' => 'text'],
            (object)['uid' => 3, 'title' => 'Record 3', 'value' => true],
            (object)['uid' => 4, 'title' => 'Record 4', 'value' => 3.14],
        ];
        $configuration = [];
